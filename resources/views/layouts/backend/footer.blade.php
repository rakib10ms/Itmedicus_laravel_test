<footer class="main-footer">
        ...
        <!-- Control Sidebar -->
        <aside class="control-sidebar control-sidebar-dark" style="display: none; top: 57px; height: 912px;">
            <!-- Control sidebar content goes here -->
            <div class="p-3 control-sidebar-content os-host os-theme-light os-host-resize-disabled os-host-scrollbar-horizontal-hidden os-host-scrollbar-vertical-hidden os-host-transition" style="height: 912px;">
    ...
    <div class="jqvmap-label" style="display: none; left: 939.125px; top: 361.016px;">Montana</div>
</body>
